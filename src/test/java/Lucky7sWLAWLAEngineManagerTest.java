...
public class Lucky7sWLAWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(Lucky7sWLAWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/Lucky7sWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/Lucky7sWLAIW/InitOutcome.xml").getDocumentElement();
